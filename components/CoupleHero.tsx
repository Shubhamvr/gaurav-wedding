          ...
          {!hasStarted && !isFinished && (
            ...
            >
              <div className="relative flex flex-col items-center">
                ...
                >
                  <svg width="50" height="50" viewBox="0 0 24 24" fill="none" className="md:w-20 md:h-20 opacity-70">
                    <path d="M18 20V17C18 15.8954 17.1046 15 16 15H14V11.5C14 10.1193 12.8807 9 11.5 9C10.1193 9 9 10.1193 9 11.5V17" stroke="#3A312A" strokeWidth="1.2" strokeLinecap="round" />
                    <path d="M14 15V13.5C14 12.1193 15.1193 11 16.5 11C17.8807 11 19 12.1193 19 13.5V17" stroke="#3A312A" strokeWidth="1.2" strokeLinecap="round" />
                    <motion.path 
                      d="M6 14L8 11L10 14L12 11L14 14" 
                      stroke="#3A312A" 
                      strokeWidth="0.8" 
                      strokeLinecap="round"
                      animate={{ 
